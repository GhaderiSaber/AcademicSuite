...
| **`methodology-expert`** | Durable Agent | `pro` | False | True | ✅ | ✅ | ✅ | `invoke_subagent`, `manage_subagents`, `send_message`, `view_file`, `list_dir`, `grep_search`, `find_by_name`, `write_to_file`, `run_command` |
| **`statistical-expert`** | Durable Agent | `pro` | False | True | ✅ | ✅ | ✅ | `invoke_subagent`, `manage_subagents`, `send_message`, `view_file`, `list_dir`, `grep_search`, `find_by_name`, `write_to_file`, `run_command` |
| **`academic-writer`** | Durable Agent | `pro` | False | True | ✅ | ✅ | ✅ | `invoke_subagent`, `manage_subagents`, `send_message`, `view_file`, `list_dir`, `grep_search`, `find_by_name`, `write_to_file`, `replace_file_content`, `run_command` |
| **`evidence-auditor`** | Durable Agent | `pro` | False | True | ✅ | ✅ | ✅ | `invoke_subagent`, `manage_subagents`, `send_message`, `view_file`, `list_dir`, `grep_search`, `find_by_name`, `write_to_file`, `run_command` |
| **`final-judge`** | Durable Agent | `pro` | False | True | ✅ | ✅ | ✅ | `invoke_subagent`, `manage_subagents`, `send_message`, `view_file`, `list_dir`, `grep_search`, `find_by_name`, `write_to_file`, `run_command` |
