...
| **Directive 13** | **Uncompromising Epistemic Honesty & Anti-Sycophancy** | Zero flattery. Report non-significant findings ($p > .05$), assumption violations, and high AI detection risks candidly without sugarcoating. | `Stop` hook / `.agents/agents/digital-saber/guard.py` |
