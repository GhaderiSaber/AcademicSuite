...
class TestVerticalSliceRegression(unittest.TestCase):
    cand_proj = os.path.join(ROOT_DIR, "tests", "fixtures", "study_vertical_slice_regression")
    PROJECT_DIR = cand_proj if os.path.isdir(cand_proj) else os.path.join(ROOT_DIR, "projects", "study_vertical_slice_regression")
