...
class TestSkillPackages(unittest.TestCase):
    ...
    def test_total_skills_count(self):
        """Asserts exactly 45 active production skills are present."""
        self.assertEqual(len(self.skill_names), 45, f"Expected exactly 45 production skills, found {len(self.skill_names)}")
