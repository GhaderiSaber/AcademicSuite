...
hooks:
  - .agents/hooks/agents/literature_expert_hook.json
---
...
2. **Directive 2 (Deterministic Calculations)**: Never calculate statistics or bibliometric indices mentally. Execute deterministic Python scripts in `.agents/skills/bibliometric-network-analyst/scripts/` to generate verified empirical matrices.
