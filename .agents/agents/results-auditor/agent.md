...
2. **Directive 2 (Audit Against Deterministic Artifacts)**: Never calculate statistics or test values mentally. Audit numerical values and APA formatting strictly against verified deterministic script outputs and execution artifacts on disk.
