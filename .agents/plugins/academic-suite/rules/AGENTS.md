...
- **Anti-pattern (AP-2026-LEAKED-INTERNAL-METHODOLOGY-TEMPLATES)**: Remove all references to internal templates or table numbers. Describe the statistical steps substantively: 'به منظور آزمون جامع این فرضیه، سلسله تحلیل‌های رگرسیونی شامل همبستگی دومتغیری، رگرسیون خطی و رگرسیون لوجیستیک دووجهی جهت برآورد مرزهای خطر بالینی انجام شد.'. [Enforcement: dynamic_invariant_guard.py (AP-2026-LEAKED-INTERNAL-METHODOLOGY-TEMPLATES)]
...
- **Anti-pattern (AP-2026-INSTRUMENT-NOUN-CONTAMINATION)**: Strip all instrument designators and author attributions from table variable columns, reporting exclusively the pure construct name ('خودآسیبی', 'افسردگی'). [Enforcement: dynamic_invariant_guard.py (AP-2026-INSTRUMENT-NOUN-CONTAMINATION)]
