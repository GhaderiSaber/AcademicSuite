...
- **Anti-pattern (AP-2026-HYPOTHESIS-QUESTION-AGGLOMERATION)**: Enforce strictly separate, dedicated H2 sections for each research question and hypothesis, formatted in flowing, cohesive academic prose. [Enforcement: dynamic_invariant_guard.py (AP-2026-HYPOTHESIS-QUESTION-AGGLOMERATION)]
