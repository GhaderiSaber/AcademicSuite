...
- **Anti-pattern (AP-2026-CORRELATION-TABLE-SINGLE-LABEL-COLUMN)**: Expand the table to have 3 distinct columns before numbering: Col 1: 'ردیف', Col 2: 'متغیر', Col 3: 'خرده‌مقیاس'. [Enforcement: dynamic_invariant_guard.py (AP-2026-CORRELATION-TABLE-SINGLE-LABEL-COLUMN)]
