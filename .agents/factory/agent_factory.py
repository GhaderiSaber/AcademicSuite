...
def get_all_target_agent_specs() -> Dict[str, AgentSpec]:
    ...
    specs: Dict[str, AgentSpec] = {
        ...
        "research-agent": AgentSpec(
            ...
            subagent=True,
            model="flash",
            tools=["view_file", "list_dir", "grep_search", "find_by_name", "read_url_content", "search_web", "write_to_file", "run_command"],
        ...
        "journal-strategist": AgentSpec(
            ...
            subagent=True,
            model="pro",
            tools=["view_file", "list_dir", "grep_search", "find_by_name", "read_url_content", "search_web", "write_to_file"],
        ...
        "project-organizer": AgentSpec(
            ...
            model="flash",
            tools=["view_file", "list_dir", "grep_search", "find_by_name", "write_to_file", "run_command"],
            skills=["academic-drive-project-organizer", "academic-adaptive-context"],
            agents=[],
            inheritCustomizations=True,
        ),
