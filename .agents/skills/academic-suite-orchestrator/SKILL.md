...
- **Lesson (LSN-2026-STRICT-ENGLISH-ORCHESTRATION-DIALOGUE-001)**: Every orchestrator turn, status report, and user interaction must be conducted strictly in English, regardless of the target artifact's native language. [Enforcement: dynamic_invariant_guard.py (LSN-2026-STRICT-ENGLISH-ORCHESTRATION-DIALOGUE-001)]
...
- **Lesson (LSN-20260925-80C880)**: Standard compliance: There is a bug in the reference generation. [Enforcement: dynamic_invariant_guard.py (LSN-20260925-80C880)]
