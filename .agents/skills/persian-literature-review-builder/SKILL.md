...
## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-ADDFC7)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-ADDFC7)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-ADDFC7)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-ADDFC7)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-C8DB97)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-C8DB97)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-C8DB97)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-C8DB97)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-D5667D)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-D5667D)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-D5667D)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-D5667D)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-D8C84B)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-D8C84B)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-D8C84B)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-D8C84B)]

## 🧠 Active Learned Behavioral Invariants
- **Lesson (LSN-20260925-2421CE)**: Standard compliance: 🧠 DETERMINISTIC ADAPTIVE CONTEXT (BOUND AT EXECUT... See [learned_invariants.md](references/learned_invariants.md). [Enforcement: dynamic_invariant_guard.py (LSN-20260925-2421CE)]
