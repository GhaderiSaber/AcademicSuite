...
- **Lesson (LSN-2026-THREE-TABLE-REGRESSION-STANDARD-001)**: Strictly enforce the 3-Table Standard for all regression model reporting across JSON schemas, markdown narratives, and DOCX tables. [Enforcement: dynamic_invariant_guard.py (LSN-2026-THREE-TABLE-REGRESSION-STANDARD-001)]
