...
- **Lesson (LSN-2026-OPENXML-TRAILING-EDGE-INVERSION-001)**: For Right-aligned text under BiDi, omit <w:jc>. Ensure section properties declare <w:bidi/>. Use jc_val='both' only for narrative body. [Enforcement: dynamic_invariant_guard.py (LSN-2026-OPENXML-TRAILING-EDGE-INVERSION-001)]
