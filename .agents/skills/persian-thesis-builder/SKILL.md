...
- **Lesson (LSN-2026-FORMATTING-AND-FILTERING-FAILURE-001)**: Enforce explicit blank line logic for headings. Implement a strict filter for Appendices to strip narrative/scoring text, retaining only the table and its title. [Enforcement: dynamic_invariant_guard.py (LSN-2026-FORMATTING-AND-FILTERING-FAILURE-001)]
- **Lesson (LSN-2026-SCHOLARLY-CONTINUOUS-PROSE-001)**: Write all narrative findings as continuous scholarly paragraphs. Never use bullets, hyphens, or numbered lists in the narrative body. Ensure table captions are 12pt B Nazanin Regular (non-bold). [Enforcement: dynamic_invariant_guard.py (LSN-2026-SCHOLARLY-CONTINUOUS-PROSE-001)]
- **Lesson (LSN-2026-NO-INLINE-COLON-LISTICLES-001)**: Never use inline colon-delimited labels or telegraphic pseudo-bullets (**موضوع:** ... **موضوع بعدی:** ...) in formal academic prose. Always weave empirical parameters into flowing, cohesive narrative paragraphs using scholarly transitions. [Enforcement: dynamic_invariant_guard.py (LSN-2026-NO-INLINE-COLON-LISTICLES-001)]
- **Lesson (LSN-2026-STRICT-QUESTION-SECTION-DECOUPLING-001)**: When Chapter 4 sections are decoupled so that each research question or hypothesis has its own dedicated section, the section's introductory paragraph and blockquotes must strictly and exclusively introduce that specific question. Never allow legacy multi-question introductions, leaked blockquotes of subsequent questions, or orphaned subsection numbers (e.g. ## ۵-۴-۴ appearing after ## ۴-۵) to remain. [Enforcement: dynamic_invariant_guard.py (LSN-2026-STRICT-QUESTION-SECTION-DECOUPLING-001)]
