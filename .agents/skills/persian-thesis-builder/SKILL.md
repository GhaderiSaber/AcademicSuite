...
- **Lesson (LSN-2026-FONT-HIERARCHY-001)**: Use B Titr ONLY for chapter names. Use 14pt B Nazanin for body, justified. Use 12pt B Nazanin for all table content/captions. No B Titr in tables. Never use manual line breaks. [Enforcement: dynamic_invariant_guard.py (LSN-2026-FONT-HIERARCHY-001)]
