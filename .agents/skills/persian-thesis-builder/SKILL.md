...
- **Lesson (LSN-2026-NARRATIVE-PRECEDES-TABLE-CAPTION-001)**: Strictly order document elements: Heading first, followed by the explanatory continuous prose narrative, then the non-bold table caption, then the table itself, and finally the table note. [Enforcement: dynamic_invariant_guard.py (LSN-2026-NARRATIVE-PRECEDES-TABLE-CAPTION-001)]
