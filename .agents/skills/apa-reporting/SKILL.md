...
- **Lesson (LSN-20260925-26F954)**: Standard compliance: So we have a problem. The table formatting is wrong and didn't trigger learning. [Enforcement: results_auditor_guard.py]
