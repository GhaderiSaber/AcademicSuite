...
In `resolved_comments.json`, fill out `action_taken` and `location` for every comment using the courteous academic templates in [academic_rebuttal_etiquette_fa.md](.agents/skills/persian-thesis-revision-assistant/references/academic_rebuttal_etiquette_fa.md):
...
Before delivering the revised documents to the student or professor, review [comment_resolution_checklist.md](.agents/skills/persian-thesis-revision-assistant/references/comment_resolution_checklist.md):
