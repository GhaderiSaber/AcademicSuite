...
article_data = {
    ...
    "introduction": [
        ...
        "Pain is rarely just physical. For college students, persistent bodily discomfort presents a quiet, daily struggle—disrupting sleep, forcing missed classes, and derailing concentration during critical exams (Treede et al., 2015; McCarthy et al., 2023). Clinical medicine long treated chronic pain as an affliction largely confined to midlife or older adulthood. Campus reality tells a very different story. Recent surveys indicate that anywhere from 15% to 40% of enrolled university students live with recurrent musculoskeletal, neuropathic, or visceral discomfort that lingers well beyond the standard three-month diagnostic threshold (Gloria-Kang et al., 2020; Raffaeli et al., 2021). This is not ordinary exam-week muscle tightness. It is an enduring, debilitating distress that collides directly with the developmental demands of emerging adulthood, setting off a troubling trajectory toward academic attrition, depressive symptoms, and chronic reliance on analgesics (Alsaggaf & Coyne, 2020; Smale et al., 2023).",

        # Para 2: Personality Vulnerability & Resilience
        "Why do two students with comparable bodily discomfort experience vastly different degrees of suffering? The answer lies beyond tissue pathology. Modern biopsychosocial models emphasize that pain severity is not a simple readout of peripheral nociceptive input; rather, it is continuously modulated by cognitive appraisals, affective states, and enduring personality architecture (Martínez et al., 2020). The Five-Factor Model offers an established framework for unpacking these individual differences (Costa & McCrae, 1992). Among the Big Five domains, neuroticism consistently emerges as the strongest psychological risk factor for chronic pain (Grouper et al., 2021). Students high in neuroticism exhibit heightened threat sensitivity and an attentional bias toward bodily sensations, routinely interpreting mild discomfort through the prism of catastrophizing—magnifying threat, ruminating on sensations, and feeling helpless (Asghari & Nicholas, 2005; Wong et al., 2014). By contrast, traits like conscientiousness, extraversion, and agreeableness appear protective. Conscientious students adhere more reliably to healthy self-care routines, extraverts mobilize peer support during acute distress, and agreeable individuals maintain supportive interpersonal relationships that buffer physiological stress responses (Newth & DeLongis, 2004; Krok & Baker, 2014; Rubén et al., 2023). Yet personality traits remain stable, entrenched dispositions. They are notoriously difficult to reshape through short-term clinical care, underscoring the urgent need to identify malleable psychological mechanisms that operate between broad personality traits and the lived experience of bodily pain.",

        # Para 3: Mechanistic Mediator - Self-Compassion
        "Here, self-compassion offers a compelling regulatory mechanism. Rather than cultivating defensive self-esteem or positive illusions, self-compassion involves treating oneself with warmth and understanding when encountering personal hardship, suffering, or bodily limitation (Neff, 2003a). Neff conceptualizes this orientation across three bidirectional components: self-kindness versus harsh self-judgment, common humanity versus feelings of isolation, and mindfulness versus over-identification (Neff, 2003b; Barnard & Curry, 2011). In chronic illness, this stance transforms how individuals relate to physical suffering (Costa & Pinto-Gouveia, 2011). Instead of viewing a pain flare-up as an intolerable catastrophe or personal failure, self-compassionate individuals recognize discomfort as an inevitable part of human life, holding painful sensations in balanced, non-reactive awareness (Davey et al., 2020). This shift has biological teeth. Drawing on Gilbert’s (2014) evolutionary model of affect regulation, self-compassion activates neurobiological soothing circuits, dampening sympathetic hyperarousal and down-regulating the chronic threat states that amplify central nociceptive signaling (Carvalho et al., 2018). Clinical evidence reinforces this framework: across diverse chronic pain populations, greater self-compassion correlates with lower pain-related disability, diminished catastrophizing, and better emotional functioning (Wren et al., 2012; Lanzaro et al., 2024; Mistretta et al., 2023).",

        # Para 4: Empirical Gap & SEM Rationale
        "How does self-compassion intersect with personality structure? Empirical studies show that self-compassion correlates inversely with neuroticism while sharing positive links with extraversion, agreeableness, and conscientiousness (Thurackal et al., 2016; Baker, 2023). When pain strikes, students high in neuroticism often collapse into self-blame and emotional isolation, paralyzing their capacity for self-kindness (Muris & Otgaar, 2020; Krejčová et al., 2023). Conversely, emotionally stable and conscientious students find it far easier to summon balanced, self-compassionate perspectives (Mohtarami Zavardeh et al., 2023; Qadriyah et al., 2020). Despite these clear connections, surprisingly few investigations have tested whether self-compassion formally mediates the pathway from personality traits to chronic pain in young adults. Most existing research relies on simple bivariate correlations or standard multiple regression. These methods are inherently limited: they cannot account for measurement error or evaluate complex structural pathways simultaneously (Ardalani Farsa et al., 2021; Rezvani & Sajjadian, 2017). Structural equation modeling (SEM) provides the necessary methodological rigor to test whether self-compassion serves as an authentic affective bridge between latent personality dimensions and subjective pain severity.",

        # Para 5: Study Aims & Hypotheses
        "To test this possibility, we evaluated a structural mediation model in 304 university students experiencing chronic pain. We proposed four hypotheses. First, Big Five personality traits will significantly predict chronic pain severity, with neuroticism predicting higher pain and adaptive traits predicting lower pain (H1). Second, personality traits will significantly predict self-compassion, with neuroticism predicting lower self-compassion and adaptive traits predicting higher self-compassion (H2). Third, self-compassion will directly and negatively predict pain severity (H3). Finally, self-compassion will partially mediate the structural relationship between personality dimensions and chronic pain severity (H4)."
    ],
    "method": {
        "design_and_participants": "We employed a cross-sectional, descriptive correlational design evaluated through Structural Equation Modeling (SEM). The study population comprised undergraduate, master's, and doctoral students enrolled at Kashan University of Medical Sciences (KAUMS, Kashan, Iran) during the 2023–2024 academic year. Recruitment proceeded through digital student channels, departmental announcement boards, and campus health center bulletins. Participants had to meet four strict eligibility criteria: (a) active enrollment at KAUMS, (b) age 18 years or older, (c) persistent or recurrent bodily pain enduring for at least three consecutive months prior to assessment (verified via standardized clinical screening), and (d) provision of informed electronic consent. We excluded acute pain originating from recent surgery or trauma within the preceding three months, active cognitive or psychotic disorders that would impair survey comprehension, and incomplete submissions. A total of 304 eligible students satisfied all criteria and completed the study protocol without missing data. Sample size adequacy was verified a priori using G*Power (Version 3.1.9.7): specifying a medium effect size (f² = 0.15), α = .05, statistical power of (1 - β) = .95, and six model predictors indicated a minimum requirement of 172 participants. Our achieved sample of N = 304 comfortably surpassed established SEM recommendations of 5 to 10 respondents per free model parameter (Kline, 2015; Bentler & Chou, 1987), providing a favorable ratio of 11.7 participants per parameter across 26 freely estimated parameters.",

        "measures": """We administered three well-validated psychological instruments:

1. Visual Analogue Scale (VAS): To quantify subjective pain intensity, students completed a standardized 10-cm horizontal Visual Analogue Scale (Price et al., 1983; Carlsson, 1983). The scale is bounded by polar verbal anchors: '0' denoting 'no pain at all' and '10' denoting 'worst imaginable pain.' Students marked the point corresponding to their average pain severity over the preceding four weeks. The VAS represents an international benchmark in pain research, displaying excellent sensitivity to subjective differences and high test-retest reliability (r = .97; Delgado et al., 2018; Freeman et al., 2001).

2. NEO Five-Factor Inventory (NEO-FFI): Personality dimensions were evaluated using the Persian version of Costa and McCrae’s (1992) 60-item short-form inventory. The tool assesses five primary domains with 12 items each: Neuroticism (N), Extraversion (E), Openness to Experience (O), Agreeableness (A), and Conscientiousness (C). Each item is rated along a 5-point Likert scale from 0 ('Strongly disagree') to 4 ('Strongly agree'), yielding domain totals between 0 and 48. Previous psychometric evaluations in Iranian student cohorts have demonstrated solid construct validity and satisfactory reliability, with alpha coefficients ranging between .74 and .86 across dimensions (Roshan et al., 2006; Garousi et al., 2001; Anisi et al., 2012).

3. Self-Compassion Scale - Short Form (SCS-SF): Self-compassionate coping was assessed via the 12-item SCS-SF (Raes et al., 2011). The inventory spans six balanced subscales: Self-Kindness (e.g., 'I try to be understanding and patient towards those aspects of my personality I don\\'t like'), Self-Judgment (e.g., 'I’m disapproving and judgmental about my own flaws and inadequacies'), Common Humanity (e.g., 'I try to see my failings as part of the human condition'), Isolation (e.g., 'When I\\'m feeling down, I tend to feel like most other people are probably happier than I am'), Mindfulness (e.g., 'When something painful happens I try to take a balanced view of the situation'), and Over-Identification (e.g., 'When I’m feeling down I tend to obsess and fixate on everything that’s wrong'). Items are scored from 1 ('Almost never') to 5 ('Almost always'). After reverse-scoring uncompassionate items, a total composite score is calculated, with higher scores reflecting greater self-compassion. The Persian version exhibits strong internal consistency (α = .86) and correlates almost identically with the 26-item long form (r ≥ .97; Shahbazi et al., 2015; Khosravi et al., 2013).""",

        "procedure": "The research protocol received formal ethical approval from the Institutional Research Ethics Committee of Kashan University of Medical Sciences (Grant No. 403043) and strictly adhered to the Declaration of Helsinki. Students accessed the questionnaire battery via an encrypted web portal. An introductory landing page outlined the study objectives, emphasized that participation was entirely voluntary, guaranteed full anonymity, and assured students that choosing to withdraw would incur no academic penalty. Survey completion required approximately 20 minutes. All incoming survey data were recorded directly into an encrypted, password-protected server.",

        "statistical_analysis": "Preliminary data screening and descriptive calculations were executed in IBM SPSS Statistics (Version 26.0). We screened for multivariate outliers using Mahalanobis distance (p < .001) and verified univariate normality through skewness and kurtosis coefficients within the accepted [-1.0, +1.0] range (Kline, 2015). Structural equation modeling was conducted with the lavaan package (Version 0.6-19; Rosseel, 2012) in R (Version 4.3.0) using Maximum Likelihood (ML) estimation. We adopted the classic two-step analytical procedure outlined by Anderson and Gerbing (1988): first validating the measurement model via Confirmatory Factor Analysis (CFA), then testing the structural mediation model. Latent personality was defined by the five NEO-FFI trait scores, latent self-compassion was indicated by the six SCS-SF facet scores, and pain severity was represented by the observed VAS score. Goodness-of-fit was judged against standard empirical cutoffs (Hu & Bentler, 1999; Kline, 2015): non-significant chi-square (p > .05), χ²/df ≤ 2.0, CFI ≥ .95, TLI ≥ .95, RMSEA ≤ .06 (with 90% confidence intervals and non-significant p_close), and SRMR ≤ .08. We tested the significance of the indirect effect using the product-of-coefficients method (a × c), calculating standard errors, z-statistics, and 95% confidence intervals."
    },
    "results": {
        "narrative": [
            "Table 1 outlines the demographic profile of the 304 participating students. Women comprised 73.7% of the cohort (n = 224) and men accounted for 26.3% (n = 80), a gender breakdown consistent with Iranian health sciences enrollment. Participant ages spanned 17 to 48 years (M = 23.90, SD = 5.61), with the largest segment (47.0%, n = 143) falling between 21 and 25 years. Regarding academic degree programs, 41.4% (n = 126) were undergraduate students, 24.3% (n = 74) were enrolled in master's programs, and 33.9% (n = 103) were pursuing medical or doctoral degrees (one student did not report degree level). Regular analgesic medication use was reported by 38.2% of participants (n = 116), whereas 61.8% (n = 188) managed their discomfort entirely through non-pharmacological coping strategies.",

            "Table 2 reports descriptive parameters and normality indices for all study variables. The mean chronic pain severity score was 5.04 (SD = 1.76; observed range 0 to 10), indicating moderate baseline pain. The mean composite self-compassion score was 39.30 (SD = 5.65; range 22 to 55). Across Big Five personality traits, mean scores were 25.14 (SD = 4.99) for neuroticism, 19.88 (SD = 3.35) for extraversion, 22.89 (SD = 3.98) for openness, 20.00 (SD = 3.12) for agreeableness, and 19.10 (SD = 3.32) for conscientiousness. Skewness indices ranged from -0.32 to 0.23, and kurtosis values ranged from -0.19 to 1.09. All values remained well within the standard [-1.0, +1.0] threshold, confirming acceptable univariate normality across variables.",

            "Bivariate Pearson correlations appear in Table 3. In line with theoretical expectations, chronic pain severity showed a moderate, statistically significant inverse correlation with self-compassion (r = -.513, p < .001). Students reporting greater self-compassion experienced noticeably milder chronic pain. Regarding personality dimensions, pain severity was positively associated with neuroticism (r = .398, p < .001), while correlating negatively with extraversion (r = -.364, p < .001), openness (r = -.381, p < .001), agreeableness (r = -.341, p < .001), and conscientiousness (r = -.430, p < .001). In contrast, self-compassion correlated negatively with neuroticism (r = -.320, p < .001), while displaying positive correlations with extraversion (r = .304, p < .001), openness (r = .381, p < .001), agreeableness (r = .310, p < .001), and conscientiousness (r = .365, p < .001).",

            "Prior to evaluating structural pathways, we tested the measurement model to confirm that observed indicators adequately reflected their intended latent constructs. Table 4 presents the standardized factor loadings (λ), all of which achieved statistical significance at p < .001. For latent personality, neuroticism loaded positively (λ = .599, z = fixed reference), whereas extraversion (λ = -.663, z = -8.744), openness (λ = -.701, z = -9.062), agreeableness (λ = -.668, z = -8.786), and conscientiousness (λ = -.674, z = -8.837) loaded negatively. This loading configuration defines a cohesive latent continuum where higher scores capture elevated neurotic vulnerability versus emotional resilience. For latent self-compassion, all six subscales exhibited substantial, statistically significant loadings: over-identification (λ = .668, z = fixed reference), self-kindness (λ = .739, z = 11.028), mindfulness (λ = .703, z = 10.592), isolation (λ = .699, z = 10.537), common humanity (λ = .719, z = 10.789), and self-judgment (λ = .721, z = 10.818). These results confirmed adequate convergent validity for both latent constructs.",

            "We next evaluated the structural mediation model via maximum likelihood estimation in lavaan. The hypothesized model demonstrated an exceptional fit to the empirical data: χ²(52, N = 304) = 57.762, p = .271; χ²/df = 1.111; baseline χ²(66) = 1345.732, p < .001; CFI = .995; TLI = .994; RMSEA = .019 (90% CI [.000, .042], p_close = .990); and SRMR = .032. The non-significant chi-square statistic, alongside the favorable RMSEA and SRMR values, indicates that the structural model successfully reproduced the sample covariance matrix.",

            "Table 5 details the unstandardized and standardized path estimates, standard errors, z-values, and 95% confidence intervals; Figure 1 depicts the model graphically. Personality traits exerted a significant negative effect on self-compassion (path a: B = -0.151, SE = 0.023, z = -6.449, p < .001, β = -.544, 95% CI [-0.197, -0.105]). Students with higher neuroticism and lower adaptive traits reported substantially lower self-compassion. Self-compassion, in turn, exerted a direct negative effect on pain severity (path c: B = -0.732, SE = 0.143, z = -5.117, p < .001, β = -.344, 95% CI [-1.013, -0.452]). The direct path from personality to pain severity also remained significant (path e: B = 0.228, SE = 0.043, z = 5.312, p < .001, β = .387, 95% CI [0.144, 0.312]). Crucially, the indirect effect of personality on pain severity through self-compassion was statistically significant (path a × c: B = 0.110, SE = 0.024, z = 4.512, p < .001, β_indirect = .187, 95% CI [0.062, 0.158]). The total effect was likewise significant (B = 0.338, SE = 0.046, z = 7.348, p < .001, β_total = .574, 95% CI [0.248, 0.428]). Because both direct and indirect pathways reached significance, the findings establish partial mediation, with self-compassion accounting for roughly 32.6% of the total association between personality traits and chronic pain severity."
        ],
        "tables": [
            {
    ...
    "discussion": [
        # Para 1: Overview
        "Chronic bodily pain among university students is frequently dismissed as simple fatigue or poor study posture. Its true toll is far heavier. In this study, we examined whether self-compassion serves as an affective buffer mediating the relationship between Big Five personality traits and chronic pain severity. The empirical findings provided clear answers. Our structural equation model reproduced the observed sample covariances with exceptional precision, confirming that personality traits influence chronic pain severity both directly and indirectly through self-compassion. Self-compassion operates as a vital psychological shock absorber. It explains why emotionally vulnerable students often suffer more intensely from physical symptoms, while resilient students experience meaningful relief.",

        # Para 2: Personality Direct Links (H1)
        "Our first hypothesis (H1) was fully supported. Neuroticism correlated positively with pain severity (r = .398), whereas extraversion, openness, agreeableness, and conscientiousness showed inverse relationships. These results mirror decades of clinical research identifying neuroticism as a primary psychological vulnerability in chronic pain (Grouper et al., 2021; Wong et al., 2014; Ibrahim et al., 2020). Students high in neuroticism maintain an attentional stance of somatic hypervigilance. When pain flares up, they routinely catastrophize—magnifying the threat, ruminating on sensations, and feeling helpless—a cognitive cascade that amplifies nociceptive signaling within the central nervous system (Asghari & Nicholas, 2005; Martínez et al., 2020). Adaptive traits, by contrast, confer clear protective advantages. Conscientious students manage health habits and medication regimens more effectively, extraverts draw on peer support to alleviate emotional distress, and agreeable individuals maintain supportive social networks that temper physiological stress reactivity (Newth & DeLongis, 2004; Krok & Baker, 2014; Rubén et al., 2023).",

        # Para 3: Self-Compassion Links (H2 & H3)
        "Our second and third hypotheses (H2 and H3) were likewise corroborated. Personality traits strongly predicted self-compassion (β = -.544), and self-compassion directly reduced pain severity (β = -.344). Students who practiced greater self-compassion reported substantially milder chronic pain (r = -.513). Why does being kind to oneself reduce physical pain? Gilbert’s (2014) evolutionary model of affect regulation provides a compelling physiological explanation. When physical pain strikes, the human threat-defense system naturally surges, triggering autonomic arousal, muscle tension, and neuroendocrine stress. Self-compassion interrupts this cascade. By meeting discomfort with self-kindness instead of frustration, viewing suffering as part of common humanity rather than isolating defectiveness, and holding physical sensations in balanced mindfulness, students de-escalate threat appraisals and engage the soothing-contentment system (Carvalho et al., 2018). This shift lowers autonomic hyperarousal and dampens central pain amplification (Wren et al., 2012; Lanzaro et al., 2024; Mistretta et al., 2023).",

        # Para 4: Mediation Mechanism (H4)
        "The centerpiece of our investigation was confirming that self-compassion partially mediates the pathway from personality traits to pain severity (indirect β = .187, p < .001). This confirms our fourth hypothesis (H4). A personality profile marked by high neuroticism and low conscientiousness strips away a student’s capacity to practice self-compassion. In moments of bodily distress, these students collapse into self-blame and emotional isolation, compounding their physical suffering. Resilient personality profiles, by contrast, nurture self-compassion, providing an internal affective buffer that tempers the subjective burden of bodily symptoms. Because the mediation was partial, personality traits also maintain direct links to pain severity (β = .387). These direct pathways likely operate through neurobiological pain thresholds, autonomic sensitivity, and genetic differences in nociceptive processing (Grouper et al., 2021).",

        # Para 5: Clinical & Campus Implications
        "These findings carry direct implications for campus counseling centers and student health clinics. Modifying entrenched personality traits through short-term psychotherapy is notoriously difficult. Self-compassion, however, is an adaptable skill that can be taught and strengthened within weeks (Neff & Germer, 2013). University students with chronic pain—particularly those struggling with high neuroticism, perfectionism, or academic stress—would benefit tremendously from structured compassion training. Group programs based on Mindful Self-Compassion (MSC; Neff & Germer, 2013) or Compassion-Focused Therapy (CFT; Gilbert, 2014) could provide accessible, non-pharmacological tools to help students break cycles of self-criticism, lower pain catastrophizing, and manage flare-ups with greater equanimity.",

        # Para 6: Strengths, Limitations & Future Directions
        "This study has notable strengths, including a verified clinical sample of 304 university students with persistent pain, the use of structural equation modeling to control for measurement error, and simultaneous examination of all Big Five traits alongside the six self-compassion facets. Certain methodological limitations must also be acknowledged. First, the cross-sectional design prevents us from making definitive causal claims. Longitudinal tracking or randomized controlled trials are needed to confirm whether boosting self-compassion directly lowers chronic pain over time. Second, we relied on self-report questionnaires, which carry inherent risks of recall and social desirability biases, even though guaranteed anonymity helped mitigate this concern. Third, our sample was recruited through convenience sampling from a single medical sciences university in Iran and consisted predominantly of women (73.7%). While this distribution matches the gender makeup of Iranian healthcare faculties, future studies should examine whether these pathways hold across non-medical students and other cultural environments. Finally, our study captured general pain severity with the VAS. Exploring specific etiologies—such as migraine, lower back pain, or dysmenorrhea—could clarify whether self-compassion buffers certain pain types more effectively than others.",

        # Para 7: Conclusion
        "In conclusion, our study shows that self-compassion serves as a crucial affective buffer linking Big Five personality traits to chronic pain severity in university students. Personality is not destiny. While personality traits establish baseline vulnerabilities, a student’s capacity for self-directed kindness and mindful acceptance directly buffers their actual symptom burden. Cultivating self-compassion represents a practical, scalable clinical strategy to reduce chronic pain suffering and support student wellbeing in higher education."
    ],
    "declarations": {
        ...
        "authors_contributions": "Z.J. conceived the study, conducted on-campus participant recruitment, collected data, and prepared the original manuscript draft. H.A. provided methodological supervision, executed structural equation modeling in R, directed project administration, and critically edited the manuscript. A.O. contributed to clinical conceptualization, provided theoretical oversight, and reviewed and approved the final manuscript for submission."
    },
    "claims_matrix": [
        {
            "claim_id": "C1",
